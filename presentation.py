...
Label(master, text="The most secure bank you've probably used", font=('Calibri', 12), bg='White').grid(row=1, column=2, pady=5, padx=5,sticky=NE)
Label(master, image=img).grid(row=2, column=2, sticky=N, pady=15)

# Buttons
Button(master, text="Register", font=('Calibri', 12), width=15, command=register, bg='DarkBlue', fg='White').grid(row=3, column=2, sticky=N)
Button(master, text="Login", font=('Calibri', 12), width=15, command=login, bg='DarkBlue', fg='White').grid(row=4,  column=2, sticky=N, pady=10)
